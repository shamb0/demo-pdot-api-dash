<template>
  <div class="hello">
    ...
    <p>
      Submitted by ...<br />
      <a href="https://github.com/shamb0" target="_blank" rel="noopener"
        >shamb0</a
      >.
    </p>
  </div>
...
export default {
  ...
  data() {
    return {
      ...
      header: {},
      headerTarget: {},
      url: ' https://kusama.subscan.io/block/'
    };
  },
  methods: {
    async formSubmit(e) {
      ...
      this.url = 'https://kusama.subscan.io/block/'+ this.headerTarget.number
    },
  },
  async mounted() {
    const wsProvider = new WsProvider("wss://kusama-rpc.polkadot.io");
